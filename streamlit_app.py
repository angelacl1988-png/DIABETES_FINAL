...
with tab1:
    ...
    <div style="background-color:#f9f9f9; padding:20px; border-radius:10px; color:#1a1a1a;">
        ...
        <em>**  Este dashboard tiene como propósito explorar los datos de NHANES y analizar de manera interactiva cuáles variables demográficas, clínicas, 
        de laboratorio y de estilo de vida están asociadas con la diabetes. Permite visualizar patrones, comparar subgrupos y facilitar la identificación de factores de riesgo potenciales,**<em>
    </div>
